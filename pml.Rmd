---
title: "Practical Machine Learning - Human Activity Recognition - Weight Lifting Exercises"
...
The goal of this assignment is to identify the best possible model to predict how well the excercise (Dumbbell Biceps Curl in this case) were perfomred by the test subjects. More detail about the project can be found at http://web.archive.org/web/20161224072740/http:/groupware.les.inf.puc-rio.br/har#weight_lifting_exercises

The model will be able to classify the exercise, performed by each subject, on a classification model. To know more about the classification model, visit the above URL.



```{r, message=FALSE}
##Downloading datasets and loading R packages libraries. 
...
### I will be training using random forest, rpart and gbm.
